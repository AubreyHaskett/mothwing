...
/// Fixed public-domain prose so benchmark runs are comparable across devices and
/// engine versions. Includes names, numbers, and abbreviations to exercise G2P.
/// Source: Jane Austen, *Pride and Prejudice* (1813), public domain.
public enum BenchmarkCorpus {
    ...
    about it." Mr. Bennet made no answer.

    "Do you not want to know who has taken it?" cried his wife impatiently. "You \
    ...
    "What is his name?" "Bingley." "Is he married or single?" "Oh! single, my \
